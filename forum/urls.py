...
from . import views
from .views import QuestionListView, QuestionDetailView, QuestionCreateView, QuestionUpdateView, QuestionDeleteView, AnswerCreateView
...
urlpatterns = [
    ...
    path('questions/new-answer/', AnswerCreateView.as_view(), name='forum-answer-create'),
